...
export const mockSubjects = [
  ...
  {
    id: 5,
    name: "Architecture des réseaux Télécoms",
    questions: 40,
    students: 25,
  },
  {
    id: 6,
    name: "Eléments généraux de transmission",
    questions: 45,
    students: 2,
  },
  {
    id: 7,
    name: "Organisation des réseaux aéro-souterraines",
    questions: 39,
    students: 22,
  },
...
export const messages = [
  ...
  },
  {
    ...
    userId: 2,
    sujet: [2],
    contenu: "Peut-on utiliser les boucles imbriquées dans une fonction récursive ?",
  ...
  },
  {
    ...
    userId: 1,
    sujet: [4],
    contenu: "Quelle est la différence entre une fonction pure et une fonction impure ?",
  ...
  },
  {
    ...
    userId: 3,
    sujet: [8],
    contenu: "Quel est le rôle du compilateur dans l'exécution d'un programme C ?",
...
export const reponses = [
  {
    ...
    messageId: 101,
    userId: 2,
    contenu: "Tu peux utiliser la formule générale : x = (-b ± √(b² - 4ac)) / 2a.",
